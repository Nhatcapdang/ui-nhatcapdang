    ...
    <Tabs>
      ...
      <TabsContents className="border rounded-xl mt-1">
        <TabsContent value="Preview">
         <Preview path="demo/components/scroll-eveal/scroll-eveal-1"/>
        </TabsContent>
        <TabsContent value="Usage">
          <CodePreview path="demo/components/scroll-eveal/scroll-eveal-1" />
        </TabsContent>
      </TabsContents>
    </Tabs>
    ...
    <Tabs>
      ...
      <TabsContents className="border rounded-xl mt-1">
        <TabsContent value="Installation" className="p-4">
         <Installation componentName="scroll-eveal" />
        </TabsContent>
        <TabsContent value="Manual">
          <CodePreview path="components/scroll/scroll-eveal" />
        </TabsContent>
      </TabsContents>
    </Tabs>
