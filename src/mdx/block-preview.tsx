...
export const BlockPreview = ({ path, componentName }: IBlockPreview) => {
      ...
      <div>
        <Tabs>
          <TabsList className="flex justify-between gap-2 w-full border-b px-1.5">
            ...
            <div className="flex gap-2">
              <Link
                href={`https://v0.dev/chat/api/open?url=https://ui.nhatcapdang.com/r/${componentName}.json`}
                target="_blank"
              >
                <Button
          ...
          <TabsContents>
            ...
            <TabsContent value="code" className="p-4">
              ...
              <Installation componentName={componentName ?? ''} />
              {/* <TabsFumadocs
                items={['npm', 'yarn', 'pnpm']}
                groupId="cli-install"
                persist
