        ...
        <div>
            <div className=" h-screen  content-center justify-items-center gap-6 text-center">
                <span className="after:from-background after:to-foreground relative max-w-[12ch] text-xs uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full after:h-16 after:w-px after:bg-primary after:content-['']">
                    scroll down to see sticky footer
                </span>
            </div>
            <footer
                className="relative [--height:550px] h-(--height)"
                style={{ clipPath: 'polygon(0% 0, 100% 0%, 100% 100%, 0 100%)' }}
            >
                <div className="relative h-[calc(100vh+var(--height))] -top-[100vh]">
                    <div className="h-(--height) sticky top-[calc(100vh-var(--height))]">
                            ...
                            <div className="mx-auto flex max-w-5xl flex-wrap items-end justify-between gap-6 px-6 py-6">
                                <Link href="/" aria-label="go home" className="block size-fit">
                                    <Image
                                        ...
                                        loading="lazy"
                                        unoptimized
                                        className="brightness-0 dark:brightness-100 w-[200px] "
                                    />
                                </Link>
